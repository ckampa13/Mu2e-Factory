...
#   Project:              Mu2e
#   Date:	        8/25/17
#   Most Recent Update: 01/02/18 -CK
#
#   Description:
...
<<<<<<< HEAD
dataFile = 'Resistance_Data\\voltage_vs_bits_tests\\resistanceA_allpass_'
=======
dataFile = 'Resistance_Data\\voltage_vs_bits_tests\\raw_data\\resistanceA_allpass_'
...
def save_resistance(worker, workstation, temp, humid, straw_dictionary,save_file,straw_start,straw_end,counter):
    print("Saving file...\n")
