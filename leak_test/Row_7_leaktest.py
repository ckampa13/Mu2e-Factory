...
chamber_volume = [544,600,534,594,612] #volume calculated on 1-2-2018 -SP
chamber_volume_err = [8,8,11,8,6]
...
#name of chambers
chamber_id = { "ch30" : 0, "ch31" : 1, "ch32" : 2, "ch33" : 3, "ch34" : 4, 0: "ch30", 1 : "ch31", 2 : "ch32", 3 : "ch33", 4 : "ch34"}
Choosenames = [ "empty30", "empty31", "empty32", "empty33", "empty34" ]
files = {}

com = "COM17" #change this to change com
...
def Change_straws() :
        ...
        if straw == "empty" : #empty chamber
                ...
                Choosenames[this_chamber] = straw + '_chamber%.0f_' % (this_chamber + 30) + datetime.now().strftime("%Y_%m_%d") 
        print(straw)
        Need_for_change()
