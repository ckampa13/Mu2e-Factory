...
chamber_volume = [557,510,550,559,527] #volume calculated on 1-2-2018 -SP
chamber_volume_err = [6,8,6,9,6]
...
#name of chambers
chamber_id = { "ch40" : 0, "ch41" : 1, "ch42" : 2, "ch43" : 3, "ch44" : 4, 0: "ch40", 1 : "ch41", 2 : "ch42", 3 : "ch43", 4 : "ch44"}
Choosenames = [ "empty40", "empty41", "empty42", "empty43", "empty44" ]
files = {}

com = "COM15" #change this to change com
...
def Change_straws() :
        ...
        if straw == "empty" : #empty chamber
                ...
                Choosenames[this_chamber] = straw + '_chamber%.0f_' % (this_chamber + 40) + datetime.now().strftime("%Y_%m_%d") 
        print(straw)
        Need_for_change()
