...
chamber_volume = [567,544,572,561,578] #volume calculated on 1-2-2018 -SP
chamber_volume_err = [7,6,8,7,6]
...
Choosenames = [ "empty45", "empty46", "empty47", "empty48", "empty49" ]
files = {}

com = "COM16" #change this to change com
...
def Change_straws() :
        ...
        if straw == "empty" : #empty chamber
                ...
                Choosenames[this_chamber] = straw + '_chamber%.0f_' % (this_chamber + 45) + datetime.now().strftime("%Y_%m_%d") 
        print(straw)
        Need_for_change()
