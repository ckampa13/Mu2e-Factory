...
#name of chambers
chamber_id = { "ch10" : 10, "ch11" : 11, "ch12" : 12, "ch13" : 13, "ch14" : 14 } 
Choosenames = [ "empty10", "empty11", "empty12", "empty13", "empty14" ]
files = {}
#create a csv file to store leak test results
result = open('C:\\Users\\vold\\Desktop\\Leak Test Results\\' + datetime.now().strftime("%Y-%m-%d_%H%M%S") + '_COM9
.csv', "a+",1)
