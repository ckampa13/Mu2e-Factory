...
chamber_volume = [592,603,612,606,567] #updated volumes 1/4/2017 -SP
chamber_volume_err = [15,12,7,4,2]
...
#name of chambers
chamber_id = { "ch10" : 0, "ch11" : 1, "ch12" : 2, "ch13" : 3, "ch14" : 4, 0 : "ch10", 1 : "ch11", 2 : "ch12", 3 : "ch13", 4 : "ch14"} 
Choosenames = [ "empty10", "empty11", "empty12", "empty13", "empty14" ]
files = {}
...
def Change_straws() :
        ...
        if straw == "empty" : #empty chamber
                ...
                Choosenames[this_chamber] = straw + '_chamber%.0f_' % (this_chamber + 10) + datetime.now().strftime("%Y_%m_%d") 
        print(straw)
        Need_for_change()
