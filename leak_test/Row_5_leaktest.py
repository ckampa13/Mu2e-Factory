...
chamber_volume = [611,600,542,594,591] #volume calculated on 1-2-2018 -SP
chamber_volume_err = [3,2,5,4,6]
...
#name of chambers
chamber_id = { "ch20" : 20, "ch21" : 21, "ch22" : 22, "ch23" : 23, "ch24" : 24 } 
Choosenames = [ "empty20", "empty21", "empty22", "empty23", "empty24" ]
files = {}
#create a csv file to store leak test results
result = open('C:\\Users\\vold\\Desktop\\Leak Test Results\\' + datetime.now().strftime("%Y-%m-%d_%H%M%S") + '_COM6.csv', "a+",1)
