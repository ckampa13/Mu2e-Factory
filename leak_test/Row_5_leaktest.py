...
com = "COM6" #change this to change com
...
def Change_straws() :
        ...
        if straw == "empty" : #empty chamber
                ...
                Choosenames[this_chamber] = straw + '_chamber%.0f_' % (this_chamber + 20) + datetime.now().strftime("%Y_%m_%d") 
        print(straw)
        Need_for_change()
