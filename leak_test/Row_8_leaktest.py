...
chamber_volume = [606,594,515,583,601] #volume calculated on 1-2-2018 -SP
chamber_volume_err = [6,10,8,10,8]
...
#name of chambers
chamber_id = { "ch35" : 0, "ch36" : 1, "ch37" : 2, "ch38" : 3, "ch39" : 4, 0: "ch35", 1 : "ch36", 2 : "ch37", 3 : "ch38", 4 : "ch39"}
Choosenames = [ "empty35", "empty36", "empty37", "empty38", "empty39" ]
files = {}

com = "COM14" #change this to change com
...
def Change_straws() :
        ...
        if straw == "empty" : #empty chamber
                ...
                Choosenames[this_chamber] = straw + '_chamber%.0f_' % (this_chamber + 35) + datetime.now().strftime("%Y_%m_%d") 
        print(straw)
        Need_for_change()
