...
chamber_volume = [598,451,627,588,649] #volume calculated on 1-22-2018 -SP
chamber_volume_err = [31,11,25,20,16]
...
#name of chambers
chamber_id = { "ch25" : 0, "ch26" : 1, "ch27" : 2, "ch28" : 3, "ch29" : 4, 0: "ch25", 1 : "ch26", 2 : "ch27", 3 : "ch28", 4 : "ch29"}
Choosenames = [ "empty25", "empty26", "empty27", "empty28", "empty29" ]
files = {}

com = "COM10" #change this to change com
...
def Change_straws() :
        ...
        if straw == "empty" : #empty chamber
                ...
                Choosenames[this_chamber] = straw + '_chamber%.0f_' % (this_chamber + 25) + datetime.now().strftime("%Y_%m_%d") 
        print(straw)
        Need_for_change()
