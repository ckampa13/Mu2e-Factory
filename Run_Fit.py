...
filename = 'st00639_chamber7_2017_09_27'
file = open('C:\\Users\\vold\\Desktop\\' + filefolder + '\\' + filename + '_rawdata.txt',"a+",1)
chamber_num = int(input("Chamber number : ")) 

#---------------------look in directory for files------------
path = 'C:\\Users\\vold\\Desktop\\' + filefolder + '\\'
...
for f in range(number_of_chambers):
        ...
        if f == chamber_num :
                ...
                with open('C:\\Users\\vold\\Desktop\\' + filefolder + '\\' + filename + '_rawdata.txt',"r+",1) as readfile :
